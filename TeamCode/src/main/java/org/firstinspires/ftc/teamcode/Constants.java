...
public class Constants {
  public static final String[] wheel_names = new String[] {"RF", "RB", "LB", "LF"}; // ordered by right front, right back, left back, left front
  ...
  public static final String outtake_servo_name = "Claw";
